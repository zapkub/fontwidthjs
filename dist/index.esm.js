 ...
 */
function calculateFontSize(text, maxWidth, fontInput, options = {}) {
 ...
 */
function parseFontInput(fontInput) {
    let buffer;
...
export { calculateFontSize, calculateFontSize as default, helloWorld };
